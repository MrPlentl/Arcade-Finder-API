...
export async function down(queryInterface) {
	...
	await queryInterface.sequelize.query(
		"DROP TRIGGER IF EXISTS trigger_set_venue_slug ON venue",
	);
	await queryInterface.sequelize.query(
		"DROP FUNCTION IF EXISTS generate_unique_slug_for_venue()",
	);
	await queryInterface.sequelize.query(
		"DROP TRIGGER IF EXISTS trigger_set_game_slug ON game",
	);
	await queryInterface.sequelize.query(
		"DROP FUNCTION IF EXISTS generate_unique_slug_for_game()",
	);
