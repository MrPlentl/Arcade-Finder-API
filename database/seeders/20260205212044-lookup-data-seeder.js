...
export async function up(queryInterface) {
  ...
  await queryInterface.bulkInsert('game_type', [
    ...
    },
    {
      ...
      description: 'Arcade cabinet that has multiple games running on it like a NEO Geo cabinet',
    },
    {
      id: 4,
      name: 'Driving / Flying Game',
      description: 'An arcade with a steering wheel to drive or joystick to fly',
    },
    {
      id: 5,
      name: 'Shooter Game',
  ...
  await queryInterface.bulkInsert('inventory_variant', [
    ...
    { id: 11, name: '8+ Player', description: null },
    {
      ...
      description: 'Dual arcade machine that plays both games through game selection',
    },
    {
      id: 13,
      name: 'Class Of 1981',
      description: '20 year reunion combo cabinet featuring Galaga and Ms. Pac-Man',
    },
    {
      id: 14,
      name: 'Candy Cab',
    ...
    },
    {
      id: 16,
      name: 'Neo Geo MVS',
      description: 'Generally a 4-slot Multi Video System (MVS) arcade cabinet',
    },
    {
      id: 17,
      name: 'Custom',
    ...
    },
    {
      ...
      description: 'An arcade system developed and marketed by Nintendo introduced in March 1984',
    },
    {
      id: 20,
      name: 'Standard Size',
